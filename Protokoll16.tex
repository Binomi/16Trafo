...
\end{empheq}
Für ein Handyladegerät würde sich aus unseren Transformator-Werten $U=200\,$V und $I_1(I_2=0\,\si{\ampere})=0.11\,$A sowie der Phasenverschiebung $\delta=0.998, 0.03$
